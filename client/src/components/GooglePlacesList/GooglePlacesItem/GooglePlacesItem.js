...
function googlePlacesItem(props) {
  return (
    ...
    >
        <ListItemAvatar>
            <Avatar style={{height: "40px", width: "40px"}} alt={props.place.types[0]} src={props.place.icon} imgProps={{style:{height: "35px", width: "35px", marginBottom: "5px"}}}></Avatar>
        </ListItemAvatar>
        <ListItemText
            ...
            secondary={
                <>
                    <Typography component="span" color="textPrimary">
                        {props.place.formatted_address ? props.place.formatted_address : ''} {props.place.opening_hours && props.place.opening_hours.open_now && "(Currently Open)"}
                    </Typography>
