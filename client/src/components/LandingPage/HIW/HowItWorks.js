  ...
  return (
    ...
    <div>
      ...
      <div className="flex flex-wrap w-85 mx-auto my-4">
         ...
         <div data-aos="fade-left"  data-aos-delay="90" className="w-50 flex  br-4 icon-card">
              <div className="w-15 flex center-content bg-primary">
                  1
              </div>
      ...
      <div className="flex flex-wrap w-85 mx-auto my-4 flex-row-rev">
          <div className="w-50 hwi-text p-4" data-aos="fade-left"  data-aos-delay="90">
          ...
          <div className="w-50 flex  br-4 icon-card" data-aos="fade-right"  data-aos-delay="90">
              <div className="w-15 flex center-content bg-secondary">
                  2
              </div>
      ...
      <div className="flex flex-wrap w-85 mx-auto my-4">
          <div className="w-50 hwi-text p-4" data-aos="fade-right"  data-aos-delay="90">
          ...
          <div className="w-50 flex br-4 icon-card" data-aos="fade-left"  data-aos-delay="90">
              <div className="w-15 flex center-content bg-primary">
                  3 
              </div>
